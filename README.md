...
|`configure_crl_oscp_rules`|Allow traffic to [Certificate Revocation List (CRL) download and/or Online Certificate Status Protocol (OCSP) locations](https://docs.microsoft.com/en-us/azure/security/fundamentals/tls-certificate-changes#will-this-change-affect-me)|
