locals {
  ...
  create_linux_scale_set_pool  = (local.create_azdo_resources && var.deploy_scale_set && var.azdo_linux_scale_set_agent_count > 0)
  create_windows_scale_set_pool= (local.create_azdo_resources && var.deploy_scale_set && var.azdo_windows_scale_set_agent_count > 0)
