...
locals {
  ...
  azdo_self_hosted_pool_name   = local.create_azdo_resources && var.deploy_self_hosted_vm_agents ? module.self_hosted_pool.0.name : null
  ...
  create_self_hosted_pool      = (var.azdo_self_hosted_pool_name != null && var.azdo_self_hosted_pool_name != "")
